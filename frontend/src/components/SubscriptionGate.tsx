    ...
    <div className="relative">
      ...
      <motion.div
        ...
        <MagneticCard
          ...
          className="card-padding-lg max-w-md mx-auto">

          <div className="liquid-glass-content text-center">
            <motion.div
              className={`w-20 h-20 bg-gradient-to-br ${info.color} rounded-3xl flex items-center justify-center text-white mb-6 mx-auto shadow-xl`}
              animate={{
                scale: [1, 1.05, 1]
              }}
              transition={{
