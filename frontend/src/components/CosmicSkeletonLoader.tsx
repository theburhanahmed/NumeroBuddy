    ...
    switch (variant) {
      case 'planet':
        return <div className={`relative ${className}`}>
            <motion.div className="w-64 h-64 rounded-full bg-gradient-to-br from-cyan-500/20 to-blue-600/20 backdrop-blur-xl border border-cyan-500/20" animate={{
            opacity: [0.3, 0.6, 0.3],
            scale: [1, 1.05, 1]
          }} transition={{
            duration: 2,
      ...
      case 'card':
        return <motion.div className={`p-6 rounded-2xl bg-[#1a2942]/40 backdrop-blur-xl border border-cyan-500/20 ${className}`} animate={{
          opacity: [0.4, 0.7, 0.4]
        }} transition={{
          duration: 1.5,
          repeat: Infinity,
      ...
      case 'text':
        return <motion.div className={`space-y-3 ${className}`} animate={{
          opacity: [0.4, 0.7, 0.4]
        }} transition={{
          duration: 1.5,
          repeat: Infinity,
      ...
      case 'cube':
        return <motion.div className={`w-24 h-24 rounded-xl bg-gradient-to-br from-cyan-500/20 to-blue-600/20 backdrop-blur-xl border border-cyan-500/20 ${className}`} animate={{
          opacity: [0.3, 0.6, 0.3],
          rotateY: [0, 180, 360]
        }} transition={{
          opacity: {
