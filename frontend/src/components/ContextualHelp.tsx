            ...
            className="fixed right-0 top-0 bottom-0 w-full max-w-md bg-[#0B0F19] border-l border-cyan-500/20 z-[91] overflow-y-auto">
              ...
              <div className="p-6 border-b border-cyan-500/20">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-xl transition-all ${activeCategory === category.id ? 'bg-gradient-to-r from-cyan-500/20 to-blue-600/20 text-white border border-cyan-500/30' : 'bg-[#1a2942]/40 text-white/70 border border-cyan-500/20 hover:border-cyan-500/40'}`}>
