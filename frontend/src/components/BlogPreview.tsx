...
},
{
  ...
  excerpt:
  'Explore the rare and powerful Master Numbers and their significance in numerology. Learn if you carry one of these special vibrations.',
  category: 'Advanced',
  date: '2024-01-12',
  readTime: '6 min',
  image: '✨'
},
{
  ...
  excerpt:
  'Use numerology to understand compatibility in love, friendship, and business. Discover which Life Paths complement yours.',
...
},
{
  ...
  excerpt:
  "Align your career path with your numerological blueprint. Find work that resonates with your soul's purpose.",
  category: 'Career',
  date: '2024-01-08',
  readTime: '7 min',
  image: '💼'
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          <motion.button
            ...
            className="hidden md:flex items-center gap-2 px-6 py-3 bg#[#1a2942]/60 backdrop-blur-xl border border-cyan-500/30 rounded-xl text-white hover:border-cyan-400 transition-colors">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <motion.div
            ...
            transition={{
              ...
              <SpaceCard
              variant="default"
              className="h-full cursor-pointer group hover:border-cyan-500/40 transition-colors"
        ...
        <motion.div
          ...
          <button
            onClick={() => navigate('/blog')}
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#1a2942]/60 backdrop-blur-xl border border-cyan-500/30 rounded-xl text-white">
