...
interface EmptyStateProps {
  ...
  actionLabel?: string;
  onAction?: () => void;
  planetType?: 'earth' | 'gas-giant' | 'ringed' | 'small';
}
export function EmptyState({
  ...
  return <motion.div initial={{
    ...
    duration: 0.3
      ...
      <SpaceCard variant="premium" className="p-12 text-center relative overflow-hidden">
        {/* Background Planet */}
        ...
        <div className="relative z-10">
          ...
          {/* Action Button */}
          {actionLabel && onAction && <motion.div initial={{
          opacity: 0,
          y: 10
        }} animate={{
          opacity: 1,
