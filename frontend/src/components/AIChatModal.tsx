              ...
              <>
                ...
                <motion.div
                  ...
                  className={`flex gap-2 ${message.sender === 'user' ? 'flex-row-reverse' : ''}`}>
                        ...
                        {/* Avatar */}
                        <div
                    className={`w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg ${message.sender === 'ai' ? 'bg-gradient-to-r from-blue-500 to-purple-600' : 'bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-gray-200 dark:border-white/20'}`}>
                    ...
                    <UserIcon className="w-4 h-4 text-gray-700 dark:text-gray-300" />
                        ...
                        {/* Message Bubble */}
                        <div
                    className={`max-w-[75%] px-3 py-2 rounded-2xl ${message.sender === 'ai' ? 'bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-white/20 dark:border-gray-700/30' : 'bg-gradient-to-r from-blue-500 to-purple-600 text-white'}`}>

                          <p className="text-sm leading-relaxed">
                            {message.content}
                          </p>
                          <p
                      className={`text-xs mt-1 ${message.sender === 'ai' ? 'text-gray-500 dark:text-gray-400' : 'text-white/80'}`}>
