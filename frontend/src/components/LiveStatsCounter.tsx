...
export function LiveStatsCounter() {
  ...
  return <section className="relative py-12 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        once: true
      }} onViewportEnter={() => setIsVisible(true)} className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          delay: index * 0.1
              ...
              <div className="p-6 rounded-2xl bg-[#1a2942]/40 backdrop-blur-xl border border-cyan-500/20 hover:border-cyan-500/40 transition-all">
                ...
                {/* Icon */}
                <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${stat.color} bg-opacity-20 flex items-center justify-center text-white mb-4`}>
                  {stat.icon}
                </div>
