...
export function FeatureHighlight({
  ...
  return <div className="relative">
      {/* Pulsing Glow */}
      <motion.div className="absolute -inset-4 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-3xl blur-xl" animate={{
      opacity: [0.3, 0.6, 0.3],
      scale: [1, 1.05, 1]
    }} transition={{
      duration: 3,
      ...
      <div className="relative">
        {/* Badge */}
        <motion.div className="absolute -top-3 -right-3 z-10" animate={{
        y: [0, -4, 0]
      }} transition={{
        duration: 2,
        repeat: Infinity,
