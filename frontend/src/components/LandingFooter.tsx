...
import { SparklesIcon, TwitterIcon, FacebookIcon, InstagramIcon, LinkedinIcon } from 'lucide-react';
...
export function LandingFooter() {
  ...
  return <footer className="relative z-10 py-12 sm:py-16 px-4 sm:px-6 border-t border-cyan-500/20">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-12 mb-8 sm:mb-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-4">
              <motion.a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-cyan-400 transition-colors" whileHover={{
              scale: 1.1,
              y: -2
            }}>
                <TwitterIcon className="w-5 h-5" />
              </motion.a>
              <motion.a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-cyan-400 transition-colors" whileHover={{
              scale: 1.1,
              y: -2
            }}>
                <FacebookIcon className="w-5 h-5" />
              </motion.a>
              <motion.a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-cyan-400 transition-colors" whileHover={{
              scale: 1.1,
              y: -2
            }}>
                <InstagramIcon className="w-5 h-5" />
              </motion.a>
              <motion.a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-cyan-400 transition-colors" whileHover={{
              scale: 1.1,
              y: -2
            }}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.product.map(link => <li key={link.label}>
                  <button onClick={() => router.push(link.href)} className="text-white/70 hover:text-cyan-400 transition-colors text-sm">
                    {link.label}
                  </button>
                </li>)}
            </ul>
