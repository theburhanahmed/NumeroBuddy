...
export function CosmicHero({
  ...
  return <section className="relative min-h-screen flex items-center px-4 sm:px-6 pt-24 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          duration: 0.8
            ...
            delay: 0.3
              ...
              {heading}
              <motion.span className="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600" animate={{
            ...
            delay: 0.5
              ...
              <SpaceButton variant="primary" size="lg" onClick={primaryCTA.onClick} icon={<ArrowRightIcon className="w-5 h-5" />}>
                {primaryCTA.label}
              </SpaceButton>
              {secondaryCTA && <SpaceButton variant="secondary" size="lg" onClick={secondaryCTA.onClick}>
                  {secondaryCTA.label}
                </SpaceButton>}
            </motion.div>

            {/* Stats */}
            {stats && stats.length > 0 && <div className="grid grid-cols-3 gap-6">
          ...
          delay: 0.3
            ...
            {/* Main Planet */}
            <motion.div className="relative w-96 h-96" animate={{
            rotateY: 360
          }} transition={{
            duration: 60,
            repeat: Infinity,
            ...
            transformStyle: 'preserve-3d'
              ...
              background: 'radial-gradient(circle at 30% 30%, #4a9eff 0%, #1e5a9e 40%, #0a2540 100%)',
              boxShadow: `
              ...
              {/* Orbital Rings */}
              {[1, 2, 3].map((ring, index) => <motion.div key={ring} className="absolute" style={{
              width: `${140 + index * 30}%`,
              height: `${140 + index * 30}%`,
              left: `${-20 - index * 15}%`,
              top: `${-20 - index * 15}%`,
            ...
            delay: 1
              ...
              <motion.div className="bg-[#1a2942]/40 backdrop-blur-2xl rounded-2xl border border-cyan-500/20 p-6 shadow-2xl shadow-cyan-500/10" animate={{
              y: [0, -10, 0]
            }} transition={{
              duration: 4,
              repeat: Infinity,
