...
import { ArrowRightIcon, TrendingUpIcon, HeartIcon, BriefcaseIcon } from 'lucide-react';
...
const caseStudies: CaseStudy[] = [{
  ...
  solution: 'Used Life Path 8 insights to understand natural leadership abilities and timing for career moves',
  result: 'Accepted promotion, increased team productivity by 40%, and found work-life balance',
  metrics: [{
    label: 'Career Growth',
    value: '2 Levels'
  }, {
  ...
  quote: "NumerAI helped me see my natural strengths clearly. The timing guidance was spot-on—I made the leap and haven't looked back."
}, {
  name: 'Sarah & Michael',
  role: 'Engaged Couple',
  avatar: '💑',
  ...
  solution: 'Compatibility analysis revealed complementary Life Paths (3 & 6) and communication strategies',
  ...
  quote: "The compatibility report was eye-opening. We learned to appreciate our differences instead of fighting them. We're now planning our wedding!"
}, {
  name: 'Priya Patel',
  role: 'Entrepreneur',
  avatar: '👩‍💻',
  ...
  challenge: 'Burnout, lost sense of purpose, struggling with business direction',
  solution: 'Daily readings and Life Path 5 guidance on embracing change and freedom',
  result: 'Pivoted business model, regained passion, and achieved work-life harmony',
  metrics: [{
  ...
  quote: "NumerAI's daily guidance kept me grounded during my pivot. Understanding my Life Path 5 need for freedom transformed how I run my business."
}];
  ...
  return <section className="relative py-20 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-12">
          {caseStudies.map((study, index) => <motion.div key={study.name} initial={{
          opacity: 0,
          y: 40
        }} whileInView={{
          opacity: 1,
              ...
              <SpaceCard variant="premium" className="overflow-hidden">
                <div className="grid lg:grid-cols-3 gap-8 p-8 md:p-12">
                  ...
                  <div className="lg:col-span-1">
                    ...
                    {/* Category Badge */}
                    <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r ${categoryColors[study.category]} bg-opacity-20 border border-white/20 mb-6`}>
                      {study.icon}
                    ...
                    <div className="space-y-3">
                      {study.metrics.map(metric => <div key={metric.label} className="flex justify-between items-center">
        ...
        once: true
          ...
          <a href="/signup" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-xl shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 transition-all">
            Start Your Journey
