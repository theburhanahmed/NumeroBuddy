...
export function SkeletonCard() {
  return <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-white/20 dark:border-gray-700/30 rounded-3xl p-6 md:p-8">
...
export function SkeletonText({
  ...
  return <motion.div className={`h-4 bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 rounded-lg ${widths[width]}`} animate={{
    opacity: [0.5, 1, 0.5]
  }} transition={{
    duration: 1.5,
    repeat: Infinity,
...
export function SkeletonCircle({
  ...
  return <motion.div className={`${sizes[size]} bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 rounded-full`} animate={{
    opacity: [0.5, 1, 0.5]
  }} transition={{
    duration: 1.5,
    repeat: Infinity,
