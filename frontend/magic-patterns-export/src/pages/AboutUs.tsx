...
import { SparklesIcon, HeartIcon, TargetIcon, UsersIcon } from 'lucide-react';
import { AccessibleSpaceBackground } from '../components/AccessibleSpaceBackground';
import { LandingNav } from '../components/LandingNav';
import { LandingFooter } from '../components/LandingFooter';
import { SpaceCard } from '../components/SpaceCard';
import { OptimizedPremium3DPlanet } from '../components/OptimizedPremium3DPlanet';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-white/70 leading-relaxed">
                <p>
                  Founded in 2023, Numerobuddy was born from a simple belief:
