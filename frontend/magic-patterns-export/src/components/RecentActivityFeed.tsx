...
const activities: Activity[] = [
{
  ...
  description:
  'Your Life Path 7 energy is strong today. Focus on introspection and spiritual growth.',
...
},
{
  ...
  description:
  'Analyzed compatibility with Sarah (Life Path 3). High harmony in creative pursuits.',
...
},
{
  ...
  description:
  'Your Personal Year 5 brings opportunities for change and adventure this week.',
  timestamp: '1 day ago',
...
},
{
  ...
  description:
  'Discovered your Expression Number 8 indicates natural leadership abilities.',
