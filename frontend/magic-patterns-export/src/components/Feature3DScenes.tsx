    ...
    <div
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <motion.div
          ...
          className="w-16 h-16 rounded-xl bg-gradient-to-br from-cyan-400/20 to-blue-600/20 backdrop-blur-xl border border-cyan-500/30 flex items-center justify-center"
          style={{
  ...
  return (
    <div
      ...
      <motion.div
        ...
        {/* Front face */}
        <motion.div
          className="absolute inset-0 bg-gradient-to-br from-pink-500/30 to-rose-600/30 backdrop-blur-xl border border-pink-400/40 rounded-2xl flex flex-col items-center justify-center"
          style={{
        ...
        {/* Back face */}
        <motion.div
          className="absolute inset-0 bg-gradient-to-br from-rose-500/30 to-pink-600/30 backdrop-blur-xl border border-rose-400/40 rounded-2xl flex flex-col items-center justify-center"
          style={{
            backfaceVisibility: 'hidden',
      ...
      <motion.div
        key={i}
        className="absolute w-8 h-8 rounded-lg bg-pink-400/20 backdrop-blur-sm border border-pink-400/30 flex items-center justify-center text-xs text-pink-300"
        style={{
          left: `${20 + i % 4 * 20}%`,
      ...
      <motion.div
        ...
        transition={{
          ...
          <div className="relative">
            {/* Glow */}
            <div
            className={`absolute inset-0 bg-gradient-to-br ${gem.color} rounded-lg blur-xl opacity-60`} />


            {/* Gemstone */}
            <div
            className={`relative w-16 h-16 bg-gradient-to-br ${gem.color} rounded-lg shadow-2xl`}
            style={{
              clipPath:
