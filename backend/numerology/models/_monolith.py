...
class RemedyEffectiveness(models.Model):
    """
    DEPRECATED: Track effectiveness of remedies over time.
    Use RemedyTracking.effectiveness_rating instead. Table kept for historical data.
    """
...
class RemedyCombination(models.Model):
    """
    DEPRECATED: Suggested remedy combinations.
    Combination logic is in-memory in RemediesService.get_remedy_combinations. Table kept for historical data.
    """
...
class FamilyUnitProfile(models.Model):
    """
    DEPRECATED: Family unit numerology profile.
    Use GenerationalAnalysis for family unit analysis. Table kept for historical data.
    """
...
class EmotionalCycle(models.Model):
    """
    DEPRECATED: Emotional cycle tracking based on numerology.
    No active feature uses this. Table kept for historical data.
    """
