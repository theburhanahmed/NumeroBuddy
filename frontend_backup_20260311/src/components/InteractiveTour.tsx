      ...
      scale: 0.9
        ...
        <div className="bg-[#1a2942]/95 backdrop-blur-2xl rounded-2xl border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 p-6">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={handleSkip} className="p-2 rounded-lg hover:bg-white/10 transition-colors" aria-label="Skip tour">
          ...
          <div className="mb-6">
            <div className="h-1 bg-[#0a1628]/60 rounded-full overflow-hidden">
              <motion.div className="h-full bg-gradient-to-r from-cyan-500 to-blue-600" initial={{
              width: 0
            }} animate={{
          ...
          <div className="flex items-center justify-between gap-4">
            <button onClick={handleBack} disabled={currentStep === 0} className={`text-sm font-medium ${currentStep === 0 ? 'text-white/30 cursor-not-allowed' : 'text-cyan-400 hover:text-cyan-300'}`}>
              ← Back
            </button>
            ...
            <div className="flex gap-2">
              ...
              <SpaceButton variant="primary" size="sm" onClick={handleNext} icon={isLastStep ? undefined : <ArrowRightIcon className="w-4 h-4" />}>
